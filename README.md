...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4382&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/telluric-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `telluric` can be installed with `conda`:
...
```
mamba install telluric
```

It is possible to list all of the versions of `telluric` available on your platform with `conda`:
...
```
mamba search telluric --channel conda-forge
```
...
mamba repoquery search telluric --channel conda-forge

# List packages depending on `telluric`:
mamba repoquery whoneeds telluric --channel conda-forge

# List dependencies of `telluric`:
mamba repoquery depends telluric --channel conda-forge
```
